...
export const projectFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		options: [
			...
			{
				displayName: 'Initial Time Tracked (Value)',
				name: 'initial_time_tracked_value',
				type: 'number',
				typeOptions: { minValue: 0 },
				default: 0,
				description: 'Historical baseline for time already tracked before the project was tracked in Teamleader (adds to reported totals)',
			},
			{
				displayName: 'Initial Time Tracked (Unit)',
				name: 'initial_time_tracked_unit',
				type: 'options',
				options: [
					{ name: 'Hours', value: 'hours' },
					{ name: 'Minutes', value: 'minutes' },
			...
			{
				displayName: 'Initial Price (Amount)',
				name: 'initial_price_amount',
				type: 'number',
				typeOptions: { minValue: 0, numberPrecision: 2 },
				default: 0,
				description: 'Historical baseline for revenue already invoiced before the project was tracked in Teamleader',
			},
			{
			...
			{
				displayName: 'Initial Cost (Amount)',
				name: 'initial_cost_amount',
				type: 'number',
				typeOptions: { minValue: 0, numberPrecision: 2 },
				default: 0,
				description: 'Historical baseline for costs already incurred before the project was tracked in Teamleader',
			},
			{
				displayName: 'Initial Cost (Currency)',
			...
			{
				displayName: 'Initial Amount Billed (Amount)',
				name: 'initial_amount_billed_amount',
				type: 'number',
				typeOptions: { minValue: 0, numberPrecision: 2 },
				default: 0,
				description: 'Historical baseline for amount already billed before the project was tracked in Teamleader',
			},
			{
				displayName: 'Initial Amount Billed (Currency)',
				name: 'initial_amount_billed_currency',
				type: 'options',
				typeOptions: { loadOptionsMethod: 'getCurrencies' },
				default: '',
				description: 'Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
			...
			{
				displayName: 'Initial Amount Paid (Amount)',
				name: 'initial_amount_paid_amount',
				type: 'number',
				typeOptions: { minValue: 0, numberPrecision: 2 },
				default: 0,
				description: 'Historical baseline for amount already paid before the project was tracked in Teamleader',
			},
			{
				displayName: 'Initial Amount Paid (Currency)',
				name: 'initial_amount_paid_currency',
				type: 'options',
				typeOptions: { loadOptionsMethod: 'getCurrencies' },
				default: '',
				description: 'Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
