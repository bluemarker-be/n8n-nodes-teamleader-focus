		...
		options: [
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to filter on completed (true) or open (false) tasks',
			},
			{
				...
				default: '',
				description:
					'Filter tasks assigned to this user (or a team the user belongs to). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Due By',
				name: 'due_by',
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to filter on scheduled tasks',
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Search for a term in the task description',
			},
			{
				displayName: 'Milestone ID',
				name: 'milestone_id',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Filter tasks linked to a specific deal (undocumented API filter)',
			},
		],
	},
