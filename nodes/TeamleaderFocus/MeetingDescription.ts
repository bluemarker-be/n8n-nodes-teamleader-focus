				...
				values: [
					{
						...
						options: [
							...
							{ name: 'Custom Location (Legacy)', value: 'customLocation' },
							{ name: 'Calendar Resource', value: 'calendarResource' },
						],
						default: 'virtual',
						description: 'Type of meeting location. Use "Address" for an inline address (replaces the deprecated "Custom Location"). Contact/Company use their linked address; provide address fields to override.',
					},
					{
						displayName: 'ID',
						name: 'id',
